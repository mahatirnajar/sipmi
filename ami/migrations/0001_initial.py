# Generated by Django 5.2 on 2025-09-07 13:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('PENIALAIN MANDIRI', 'Penilaian Mandiri'), ('PENIALAIN AUDITOR', 'Penilaian Auditor'), ('SELESAI', 'SELESAI')], default='DRAFT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama', models.CharField(max_length=255)),
                ('fakultas', models.CharField(choices=[('FKIP', 'FKIP'), ('FISIP', 'FISIP'), ('FEB', 'FEB'), ('FAKUM', 'FAKUM'), ('FAPERTA', 'FAPERTA'), ('FATEK', 'FATEK'), ('FMIPA', 'FMIPA'), ('FAHUT', 'FAHUT'), ('FK', 'FK'), ('FAPETKAN', 'FAPETKAN'), ('FKM', 'FKM'), ('Pascasarjana', 'Pascasarjana')], max_length=200)),
                ('jenjang', models.CharField(choices=[('D3', 'Diploma 3'), ('D4', 'Diploma 4'), ('S1', 'Sarjana'), ('S2', 'Magister'), ('S3', 'Doktor')], max_length=50)),
                ('akreditasi', models.CharField(blank=True, choices=[('unggul', 'UNGGUL'), ('baik_sekali', 'BAIK SEKALI'), ('baik', 'BAIK'), ('A', 'A'), ('B', 'B'), ('C', 'C'), ('belum', 'Belum Terakreditasi')], max_length=50, null=True)),
